...
which don't have a hardware RNG.  There's no seed to set (the OS sets that internally using 
accumulated system entropy), and multiple threads in parallel won't read
the same bytes.
